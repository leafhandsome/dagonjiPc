<template>
  <div>
    <canvas id="can1" width="1400" height="1150"></canvas>
  </div>
</template>
<script>
  export default {
    ...
    data () {
      return {
        ...
        //10位数 5个号码
        move1:[{x:351,y:90},{x:562,y:90},{x:774,y:90},{x:986,y:90},{x:1199,y:90}],
        //6位数 3个号码
        move2:[{x:310,y:90},{x:664,y:90},{x:1018,y:85}],
        //11位数 5个号码
        move3:[{x:331,y:90},{x:542,y:90},{x:754,y:90},{x:966,y:90},{x:1179,y:90}],
        //10位数 4个号码
        move4:[{x:353,y:90},{x:618,y:90},{x:883,y:90},{x:1148,y:90}]
      }
    },
    mounted(){
